...
public class PlayerMenu extends AbstractGameState {
    ...
    public void initialize(Map<String, Object> data) {
        ...
        initializeButton(_CharaterButton,R.drawable.bg_other,R.drawable.bg_adventure_press, _buttondx +178+170,_buttondy,Game.ADV_PAGE);
    ...
    public void initializeButton(BitmapButton Button,int image_a,int image_b,int x,int y,int state) {
